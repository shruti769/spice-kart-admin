export default function RefundModal({ v }) {
  return (
    <>
        ...
        <div style={{ width: "500px", maxWidth: "100%", background: "#fff", borderRadius: "14px", boxShadow: "0 26px 60px rgba(10,18,12,.3)", overflow: "hidden", display: "flex", flexDirection: "column" }}>
          <div style={{ padding: "16px 18px 14px", display: "flex", alignItems: "flex-start", gap: "11px", borderBottom: "1px solid #EFF1ED" }}>
            ...
            <span style={{ display: "flex", flexDirection: "column", gap: "4px", minWidth: "0" }}>
              <span style={{ font: "700 15px/1.2 Inter,system-ui,sans-serif", color: "#17201A" }}>Review refund RF-2188</span>
              <span style={{ font: "400 11.5px/1.55 Inter,system-ui,sans-serif", color: "#7C8A81" }}>
                Daniel Cruz requested $24.50 back on order #SK10478 — reason: missing item.
              </span>
            </span>
          </div>
          <div style={{ padding: "15px 18px", display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <span style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              <span style={{ font: "600 10.5px/1.2 Inter,system-ui,sans-serif", letterSpacing: ".4px", color: "#7C8A81", textTransform: "uppercase" }}>INTERNAL NOTE</span>
              <span style={{ display: "block", minHeight: "56px", padding: "10px 11px", border: "1px solid #E4E7E2", borderRadius: "8px", background: "#fff", font: "400 12px/1.6 Inter,system-ui,sans-serif", color: "#4A564E" }}>
                Shopper confirmed the sourdough loaf was out of stock and not substituted. Approving full refund.
              </span>
            </span>
            <span style={{ display: "flex", gap: "9px" }}>
              <button onClick={v.confirmModal} style={{ flex: "1", height: "38px", border: "1px solid #EEDAD5", borderRadius: "8px", background: "#FDF7F5", font: "600 12.5px/1.2 Inter,system-ui,sans-serif", color: "#A93826", cursor: "pointer", whiteSpace: "nowrap" }}>
                Reject refund
              </button>
              <button onClick={v.confirmModal} style={{ flex: "1", height: "38px", border: "1px solid #E4E7E2", borderRadius: "8px", background: "#fff", font: "600 12.5px/1.2 Inter,system-ui,sans-serif", color: "#17201A", cursor: "pointer", whiteSpace: "nowrap" }}>
                Refund to wallet
              </button>
            </span>
          </div>
